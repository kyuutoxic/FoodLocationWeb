...
public class ApiFollowController {
    ...
    @DeleteMapping("/follow/{idFollow}")
    public ResponseEntity<Map<String, String>> deleteFollow(@PathVariable(value = "idFollow") int idFollow,
            HttpSession session) {
        if (this.followService.deleteFollow(idFollow) == true) {
